...
export const DRIVER_LOCATION_BACKEND_UPDATE_INTERVAL_MS = 5000;
export const PASSENGER_LOCATION_SEND_INTERVAL_MS = 7000;
export const ACTIVE_RIDE_BACKGROUND_SEND_INTERVAL_MS = 8000;
...
export const PASSENGER_TRIP_STATUS_CHECK_INTERVAL_MS = 30_000;
